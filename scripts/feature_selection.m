function mask = feature_selection(result_features,Features,filter,sensors,patient)
addpath('mi/');
...
for f = 1:feature_numbers
    ...
    switch(Features(f))
        case 0
            ...
            selected_features_c(f,sensor) = result_corr(sensor).shift;
        ...
        case 1
            ...
            selected_features_c(f,sensor) = result_corr(sensor).depth;
        ...
        case 2
            ...
            selected_features_c(f,sensor) = result_corr(sensor).counts;
        ...
        case 3
            ...
            selected_features_c(f,sensor) = result_corr(sensor).entropy;
            end
        ...
        case 4
            ...
            selected_features_c(f,sensor) = result_corr(sensor).Corr;
            end
        ...
        case 5
            ...
            selected_features_c(f,sensor) = result_corr(sensor).shift2;
        ...
        case 6
            ...
            selected_features_c(f,sensor) = result_corr(sensor).sumLoco;
        ...
        case 7
            ...
            selected_features_c(f,sensor) = result_corr(sensor).I;
         ...
         case 8
            ...
            selected_features_c(f,sensor) = result_corr(sensor).freezeIndex;           
         ...
         case 9
            ...
            selected_features_c(f,sensor) = result_corr(sensor).sumAll;            
         ...
         case 10
            ...
            selected_features_c(f,sensor) = result_corr(sensor).smooth;            
         ...
         case 11
            ...
            selected_features_c(f,sensor) = result_corr(sensor).Cwt;            
         ...
         case 12
            ...
            selected_features_c(f,sensor) = result_corr(sensor).portion;            
...
for f=1:feature_numbers
for sensor = 1:sensors
    if(selected_features(f,sensor)>0.035)
        mask(f,sensor)=1;
    end
end
end
