    ...
    for isensor=0:2
        ...
        for iaxis=0:2
            ...
            for r = 1:1
                ...
                res1(1+isensor*3+iaxis) = x_fi2(data(:,2+isensor*3+iaxis),SR,stepSize,data);
               ...
               %%
                ...
                buffer_all = [];
                 for n=1:9
                   buffer_all = [buffer_all;res1(n).buffer'];
                 end
               ...
               datadir2 = 'data2/';
                ...
                switch isubject
                    case 1
                        save([datadir2 'FoG_data_all_1.mat'],'FoG_data');
                    case 2
                        save([datadir2 'FoG_data_all_2.mat'],'FoG_data');
                    case 3
                        save([datadir2 'FoG_data_all_3.mat'],'FoG_data');
                    case 5
                        save([datadir2 'FoG_data_all_5.mat'],'FoG_data');
                    case 6
                        save([datadir2 'FoG_data_all_6.mat'],'FoG_data');
                    case 7
                        save([datadir2 'FoG_data_all_7.mat'],'FoG_data');
                    case 8
                        save([datadir2 'FoG_data_all_8.mat'],'FoG_data');
                    case 9
                        save([datadir2 'FoG_data_all_9.mat'],'FoG_data');
